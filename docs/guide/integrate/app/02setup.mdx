...
https://github.com/ahqstore/cli/releases

The releases with the name
...
:::tip Why not an npm version
Good question, we're working on that and will share the status of that very soon! Stay Tuned
:::
