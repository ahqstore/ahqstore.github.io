...
// node_modules/.pnpm/@astrojs+starlight@0.23.1_astro@4.8.6_@types+node@20.12.12_/node_modules/@astrojs/starlight/schema.ts
import { z as z8 } from "astro/zod";

// node_modules/.pnpm/@astrojs+starlight@0.23.1_astro@4.8.6_@types+node@20.12.12_/node_modules/@astrojs/starlight/schemas/head.ts
import { z } from "astro/zod";
var HeadConfigSchema = () => z.array(
  z.object({
...
// node_modules/.pnpm/@astrojs+starlight@0.23.1_astro@4.8.6_@types+node@20.12.12_/node_modules/@astrojs/starlight/schemas/prevNextLink.ts
import { z as z2 } from "astro/zod";
var PrevNextLinkConfigSchema = () => z2.union([
  z2.boolean(),
  z2.string(),
  z2.object({
...
// node_modules/.pnpm/@astrojs+starlight@0.23.1_astro@4.8.6_@types+node@20.12.12_/node_modules/@astrojs/starlight/schemas/tableOfContents.ts
import { z as z3 } from "astro/zod";
var defaults = { minHeadingLevel: 2, maxHeadingLevel: 3 };
var TableOfContentsSchema = () => z3.union([
  z3.object({
    /** The level to start including headings at in the table of contents. Default: 2. */
    minHeadingLevel: z3.number().int().min(1).max(6).optional().default(2),
    /** The level to stop including headings at in the table of contents. Default: 3. */
    maxHeadingLevel: z3.number().int().min(1).max(6).optional().default(3)
  }),
  z3.boolean().transform((enabled) => enabled ? defaults : false)
...
// node_modules/.pnpm/@astrojs+starlight@0.23.1_astro@4.8.6_@types+node@20.12.12_/node_modules/@astrojs/starlight/schemas/badge.ts
import { z as z4 } from "astro/zod";
var badgeSchema = () => z4.object({
  variant: z4.enum(["note", "danger", "success", "caution", "tip", "default"]).default("default"),
  text: z4.string()
});
var BadgeConfigSchema = () => z4.union([z4.string(), badgeSchema()]).transform((badge) => {
...
// node_modules/.pnpm/@astrojs+starlight@0.23.1_astro@4.8.6_@types+node@20.12.12_/node_modules/@astrojs/starlight/schemas/hero.ts
import { z as z5 } from "astro/zod";

// node_modules/.pnpm/@astrojs+starlight@0.23.1_astro@4.8.6_@types+node@20.12.12_/node_modules/@astrojs/starlight/user-components/file-tree-icons.ts
var FileIcons = {
...
// node_modules/.pnpm/@astrojs+starlight@0.23.1_astro@4.8.6_@types+node@20.12.12_/node_modules/@astrojs/starlight/components/Icons.ts
var BuiltInIcons = {
...
var HeroSchema = ({ image }) => z5.object({
  /**
  ...
  actions: z5.object({
    ...
    variant: z5.enum(["primary", "secondary", "minimal"]).default("minimal"),
    /**
     * An optional icon to display alongside the link text.
     * Can be an inline `<svg>` or the name of one of Starlight’s built-in icons.
     */
    icon: z5.union([z5.enum(iconNames), z5.string().startsWith("<svg")]).transform((icon) => {
      const parsedIcon = z5.enum(iconNames).safeParse(icon);
      return parsedIcon.success ? { type: "icon", name: parsedIcon.data } : { type: "raw", html: icon };
    }).optional(),
    /** HTML attributes to add to the link */
    attrs: z5.record(z5.union([z5.string(), z5.number(), z5.boolean()])).optional()
  }).array().default([])
});

// node_modules/.pnpm/@astrojs+starlight@0.23.1_astro@4.8.6_@types+node@20.12.12_/node_modules/@astrojs/starlight/schemas/sidebar.ts
import { z as z6 } from "astro/zod";

// node_modules/.pnpm/@astrojs+starlight@0.23.1_astro@4.8.6_@types+node@20.12.12_/node_modules/@astrojs/starlight/utils/path.ts
...
// node_modules/.pnpm/@astrojs+starlight@0.23.1_astro@4.8.6_@types+node@20.12.12_/node_modules/@astrojs/starlight/schemas/sidebar.ts
var SidebarBaseSchema = z6.object({
  /** The visible label for this item in the sidebar. */
  label: z6.string(),
  /** Translations of the `label` for each supported language. */
  translations: z6.record(z6.string()).default({}),
  /** Adds a badge to the link item */
  badge: BadgeConfigSchema()
});
var SidebarGroupSchema = SidebarBaseSchema.extend({
  /** Whether this item should be collapsed by default. */
  collapsed: z6.boolean().default(false)
});
var linkHTMLAttributesSchema = z6.record(
  z6.union([z6.string(), z6.number(), z6.boolean(), z6.undefined()])
);
var SidebarLinkItemHTMLAttributesSchema = () => linkHTMLAttributesSchema.default({});
var SidebarLinkItemSchema = SidebarBaseSchema.extend({
  /** The link to this item’s content. Can be a relative link to local files or the full URL of an external page. */
  link: z6.string(),
  /** HTML attributes to add to the link item. */
  attrs: SidebarLinkItemHTMLAttributesSchema()
});
var AutoSidebarGroupSchema = SidebarGroupSchema.extend({
  /** Enable autogenerating a sidebar category from a specific docs directory. */
  autogenerate: z6.object({
    /** The directory to generate sidebar items for. */
    directory: z6.string().transform(stripLeadingAndTrailingSlashes),
    /**
...
var ManualSidebarGroupSchema = SidebarGroupSchema.extend({
  /** Array of links and subcategories to display in this category. */
  items: z6.lazy(
    () => z6.union([SidebarLinkItemSchema, ManualSidebarGroupSchema, AutoSidebarGroupSchema]).array()
  )
});
var SidebarItemSchema = z6.union([
  SidebarLinkItemSchema,
  ManualSidebarGroupSchema,
  AutoSidebarGroupSchema
]);

// node_modules/.pnpm/@astrojs+starlight@0.23.1_astro@4.8.6_@types+node@20.12.12_/node_modules/@astrojs/starlight/schemas/i18n.ts
import { z as z7 } from "astro/zod";
var defaultI18nSchema = () => starlightI18nSchema().merge(pagefindI18nSchema()).merge(expressiveCodeI18nSchema());
function i18nSchema({
  extend = z7.object({})
} = {}) {
  return defaultI18nSchema().merge(extend);
}
function starlightI18nSchema() {
  return z7.object({
    "skipLink.label": z7.string().describe(
      "Text displayed in the accessible “Skip link” when a keyboard user first tabs into a page."
    ),
    "search.label": z7.string().describe("Text displayed in the search bar."),
    "search.shortcutLabel": z7.string().describe("Accessible label for the shortcut key to open the search modal."),
    "search.cancelLabel": z7.string().describe("Text for the “Cancel” button that closes the search modal."),
    "search.devWarning": z7.string().describe("Warning displayed when opening the Search in a dev environment."),
    "themeSelect.accessibleLabel": z7.string().describe("Accessible label for the theme selection dropdown."),
    "themeSelect.dark": z7.string().describe("Name of the dark color theme."),
    "themeSelect.light": z7.string().describe("Name of the light color theme."),
    "themeSelect.auto": z7.string().describe("Name of the automatic color theme that syncs with system preferences."),
    "languageSelect.accessibleLabel": z7.string().describe("Accessible label for the language selection dropdown."),
    "menuButton.accessibleLabel": z7.string().describe("Accessible label for the mobile menu button."),
    "sidebarNav.accessibleLabel": z7.string().describe(
      "Accessible label for the main sidebar `<nav>` element to distinguish it fom other `<nav>` landmarks on the page."
    ),
    "tableOfContents.onThisPage": z7.string().describe("Title for the table of contents component."),
    "tableOfContents.overview": z7.string().describe(
      "Label used for the first link in the table of contents, linking to the page title."
    ),
    "i18n.untranslatedContent": z7.string().describe(
      "Notice informing users they are on a page that is not yet translated to their language."
    ),
    "page.editLink": z7.string().describe("Text for the link to edit a page."),
    "page.lastUpdated": z7.string().describe("Text displayed in front of the last updated date in the page footer."),
    "page.previousLink": z7.string().describe("Label shown on the “previous page” pagination arrow in the page footer."),
    "page.nextLink": z7.string().describe("Label shown on the “next page” pagination arrow in the page footer."),
    "page.draft": z7.string().describe(
...
function pagefindI18nSchema() {
  return z7.object({
    ...
    "pagefind.search_suggestion": z7.string().describe(
    ...
    "pagefind.searching": z7.string().describe(
...
function expressiveCodeI18nSchema() {
  return z7.object({
    "expressiveCode.copyButtonCopied": z7.string().describe('Expressive Code UI translation. English default value: `"Copied!"`'),
    "expressiveCode.copyButtonTooltip": z7.string().describe('Expressive Code UI translation. English default value: `"Copy to clipboard"`'),
    "expressiveCode.terminalWindowFallbackTitle": z7.string().describe('Expressive Code UI translation. English default value: `"Terminal window"`')
  }).partial();
}

// node_modules/.pnpm/@astrojs+starlight@0.23.1_astro@4.8.6_@types+node@20.12.12_/node_modules/@astrojs/starlight/schema.ts
var StarlightFrontmatterSchema = (context) => z8.object({
   ...
   */
  editUrl: z8.union([z8.string().url(), z8.boolean()]).optional().default(true),
   ...
   */
  template: z8.enum(["doc", "splash"]).default("doc"),
   ...
   */
  lastUpdated: z8.union([z8.date(), z8.boolean()]).optional(),
  /**
  ...
  pagefind: z8.boolean().default(true),
  /**
   ...
   */
  draft: z8.boolean().default(false)
});
...
//# sourceMappingURL=@astrojs_starlight_schema.js.map
