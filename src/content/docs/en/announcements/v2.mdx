...
v1.5 was expected to be a small release with a small set of features, but it ended up with a massive rewrite of the whole of AHQ Store backend, including but not limited to, service rewrite, linux platform support, http server rewrite, website rewrite and many more. That's why we're renaming it to AHQ Store
</Aside>
